...
function BoardView({ groupedTasks, onOpenTask, onMoveTask, onRequestDelete }) {
  return (
...
function TaskCard({ task, onOpenTask, onMoveTask, onRequestDelete }) {
  return (
...
function TaskModal({ task, onClose, onSave, onRequestDelete, owners }) {
